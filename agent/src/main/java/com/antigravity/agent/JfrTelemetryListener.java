...
/**
 * Production JFR Telemetry Listener using Java 17 RecordingStream API
 * to capture live JVM Garbage Collection events with zero external agent overhead.
 */
public class JfrTelemetryListener implements AutoCloseable {
    ...
    public void startStreaming() {
        try {
            ...
            System.err.println("JFR RecordingStream unavailable in current JVM context: " + e.getMessage());
        }
    }
